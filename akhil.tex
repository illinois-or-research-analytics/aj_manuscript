...
\section{Introduction} The problem of identifying and describing research communities in the modern scientific enterprise motivates the work presented in this article. We argue that a quantitative understanding of the organization of the scientific enterprise can support planning, analysis, and evaluation in the governance of science from the perspective of policy makers, funders, research institutions and the evaluation community. Since research communities are expressions of scientific specialization \citep{Chubin1976,Morris2009} that can span traditional disciplinary definitions \citep{Waltman2012}, an opportunity exists to study them beyond the large scale aggregations of disciplines-- at scale and in the modern research enterprise. Consequently, we are interested in scalable methods for the identification and characterization of research communities. An additional motivation is that, on account of expansion, increased funding, globalization, and industrial-scale reorganization, the community structure of science is unlikely to mirror earlier observations \citep{Kuhn1970,Price1966,small_specialties_1979,crane1972invisible}.

A window through which research communities can be examined is citation analysis. This approach is built on the assumption that members of a research community are more likely to cite each other's work than the work of others. Thus, in the graph (or network) of scientific literature, citation dense areas suggest the existence of communities. The authors of such communities of publications can then be assumed to comprise a research community. Discovering such communities can then be  framed as a community finding problem where a community is defined as a set of vertices in a graph that exhibit greater similarity to each other than vertices outside such a community. This similarity can be defined in various ways- in our case, we measure citation density. A considerable literature exists on community finding in graphs, and a variety of community finding or clustering approaches have been used in scientometrics~\citep{Newman2006,Fortunato2009,Boyack2010,Boyack2019,Traag2019,Ahlgren2020,Chandrasekharan2021,Wedell2022}. It must be stressed that citation density is not a convincing argument for the existence of a community. However, community finding techniques for graphs are valuable in being able to efficiently search large datasets for putative communities that can be qualitatively examined by domain experts using complementary techniques.  

Beyond detection, we are especially interested in substructure (structure within communities), as it reflects roles and dynamics among members. \cite{Price1966}, in their study of the oxidative phosphorylation community, reported center–periphery substructure \citep{Breiger2014}; a small core of influential researchers and a much larger transient population. Core–periphery or center–periphery patterns have been reported in other networks using different techniques, such as block modeling and k-core decomposition arguing for generality in their occurrence [CITE Rombach, Haveman, Gallgher, Sengupta, others].

We have recently reported an algorithm that is implemented in a scalable pipeline for community finding. In this article, we acknowledge the linitations of disjoint clustering. Now we're trying to fix this. Hence AOC...
