...
\begin{figure}[H]
 ...
 \hfill
	\begin{subfigure}[t]{0.48\textwidth}
    	...
    	\end{subfigure}
\caption{Increase in cluster size after enrichment through AOC. Clusters were generated by IKC using values of k ranging from 10-50. These clusters were then enriched through the AOC process enforcing either \emph{k} (left panel) or \emph{mcd} (right panel). The input to AOC was the set of nodes in the IKC clusters.}
\label{fig:fig1}
\end{figure}
