...
Also in AOC\_m, we find publications in group 2 that are Tier 1 in up to 7 communities, publications in group 3 that are Tier 1 in 8 or more communities, and a publication in group 4 that is in Tier 1 for 15 communities.
...
Since AOC\_m represents are more restrictive criterion, this shows that clusters 3 and 4 have a strong relationship  to each other and a omewhat weaker relationship to cluster 25 (but one that is nevertheless
worth noting).  
...
\section*{Acknowledgments} We thank Digital Science, Google, and the Grainger Foundation. We thank Alison Abritis and Ivan Oransky from Retraction for helpful suggestions and for making Retraction Watch data available. 
