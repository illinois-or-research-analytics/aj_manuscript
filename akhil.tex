...
\caption{AOC\_k but not AOC\_m incorporates high-degree singleton nodes from IKC\_k10 into clusters. Some number TBD of high-degree singletons left unclustered from IKC\_k10 were used as as candidate nodes for AOC\_m and AOC\_k treatment of IKC\_k10 clusters. No change in cluster size occurs after AOC\_m treatment whereas an increase occurs after the more permissive AOC\_k protocol. Data are shown for all 128 clusters generated by IKC\_k10. The}
\label{fig:singleton}
\end{figure}
...
\begin{figure}[H]
	\centering
	 \includegraphics[width=0.7\linewidth]{alt_singletons.pdf} 
\caption{AOC\_k but not AOC\_m incorporates high-degree singleton nodes from IKC\_k10 into clusters. Some number TBD of high-degree singletons left unclustered from IKC\_k10 were used as as candidate nodes for AOC\_m and AOC\_k treatment of IKC\_k10 clusters. No change in cluster size occurs after AOC\_m treatment whereas an increase occurs after the more permissive AOC\_k protocol. Data are shown for all 128 clusters generated by IKC\_k10. The}
