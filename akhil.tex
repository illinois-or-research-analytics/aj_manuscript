...
\begin{figure}[H]
 ...
 \hfill
	\begin{subfigure}[t]{0.48\textwidth}
    	...
    	\end{subfigure}
\captionsetup{width=0.9\textwidth}	
\caption{Highly cited nodes and cluster assignments. For AOC\_m (left panel) and AOC\_k (right panel) treatment of IKC\_k10 output, the in-graph citation count of nodes is plotted against the number of communities a node is assigned to. Nodes are in five groups (panels in figure) according to their in-graph citation count. gp 1: 0-9 citations, gp 2: 10-99 citations, gp 3: 100-999 citations, gp 4: 1000-9999 citations, gp 5: $\geq$10,000 citations. The number of data points in each group is shown on the right hand side.
