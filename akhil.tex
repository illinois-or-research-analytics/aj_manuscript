...
\section{Conclusions} In this article, we step delicately between method development and exploratory discovery. One goal was to construct a modular pipeline that could allow users to flexibly apply it to a variety of problems. The second 
goal was to develop the understanding of communications in the area(s) of research specialization engaged in extracellular vesicle research. 

In describing a method that can be applied in a subject-independent manner we have attempted to superimpose contextual relevance through controlling the input data and evaluation criteria \citep{vonluxburg2012clustering}.  
