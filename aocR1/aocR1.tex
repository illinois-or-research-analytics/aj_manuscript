...
\added[id=gc]{Our overall vision is ambitious; a scalable modular pipeline that supports identifying and characterizing research communities. The pipeline involves a mixed methods approach, beginning with constructing a citation network and processing it in an automated manner but ending with interpretation by experts.We subscribe to this vision but, in this article, restrict ourselves to discussing one module that we have developed for it.}
